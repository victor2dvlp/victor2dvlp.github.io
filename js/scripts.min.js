...
function scaleVideoContainer(){var e=$(window).height()+5,n=parseInt(e)+"px";$(".homepage-hero-module").css("height",n)}function initBannerVideoSize(e){$(e).each(function(){$(this).data("height",$(this).height()),$(this).data("width",$(this).width())}),scaleBannerVideoSize(e)}function scaleBannerVideoSize(e){var n,t,i=$(window).width(),o=$(window).height()+5;$(e).each(function(){var e=$(this).data("height")/$(this).data("width");$(this).width(i),i<1e3&&(n=(t=o)/e,$(this).css({"margin-top":0,"margin-left":-(n-i)/2+"px"}),$(this).width(n).height(t)),$(".homepage-hero-module .video-container video").addClass("fadeIn animated")})}$(document).ready(function(){scaleVideoContainer(),initBannerVideoSize(".video-container .poster img"),initBannerVideoSize(".video-container .filter"),initBannerVideoSize(".video-container video"),$(window).on("resize",function(){scaleVideoContainer(),scaleBannerVideoSize(".video-container .poster img"),scaleBannerVideoSize(".video-container .filter"),scaleBannerVideoSize(".video-container video")}),$(".mynavbar")[0].getBoundingClientRect().top<=0&&($(".mynavbar").css({position:"fixed",top:"0"}),$(".whoami").css("padding-top",$(".mynavbar").innerHeight())),$(".mynavbar li").on("click",function(){var e=$(this).children("a").attr("href"),n=$(e).offset().top-$(".mynavbar").innerHeight();return console.log("destination: "+n),$("html").animate({scrollTop:n},1e3),!1}),$(".respmenu-item").on("click",function(){var e=$(this).children(".fa").attr("href"),n=$(e).offset().top-$(".mynavbar").innerHeight();return $("html").animate({scrollTop:n},1e3),console.log("destination: "+n),!1}),$("#review").on("click",function(){var e=$("#about").offset().top;$("html").animate({scrollTop:e-$(".mynavbar").innerHeight()},500,"swing")}),$(".skills").css("height",$(".more-wrap")[0].clientHeight+300+"px"),$(window).scroll(function(){$(".mynavbar li").removeAttr("style"),$(".mynavbar .respmenu-item").removeAttr("style"),$(".mynavbar .respmenu-item a").removeAttr("style"),0==$("#home")[0].getBoundingClientRect().top&&($('.mynavbar [href="#home"]').parent("li").css("background","#fff"),$('.mynavbar [href="#home"]').parent(".respmenu-item").css({background:"#fff",color:"#000"}),$('.mynavbar [href="#home"]').parent(".respmenu-item").children("a").css({color:"#000"})),$("#about")[0].getBoundingClientRect().top<window.innerHeight&&0<$("#about")[0].getBoundingClientRect().top&&($('.mynavbar [href="#about"]').parent("li").css("background","#fff"),$('.mynavbar [href="#about"]').parent(".respmenu-item").css({background:"#fff",color:"#000"}),$('.mynavbar [href="#about"]').parent(".respmenu-item").children("a").css({color:"#000"})),$("#about")[0].getBoundingClientRect().top<0&&$("#skills")[0].getBoundingClientRect().bottom>window.innerHeight&&($('.mynavbar [href="#skills"]').parent("li").css("background","#fff"),$('.mynavbar [href="#skills"]').parent(".respmenu-item").css({background:"#fff",color:"#000"}),$('.mynavbar [href="#skills"]').parent(".respmenu-item").children("a").css({color:"#000"})),0<$("#work")[0].getBoundingClientRect().top&&$("#skills")[0].getBoundingClientRect().bottom<window.innerHeight&&($('.mynavbar [href="#work"]').parent("li").css("background","#fff"),$('.mynavbar [href="#work"]').parent(".respmenu-item").css({background:"#fff",color:"#000"}),$('.mynavbar [href="#work"]').parent(".respmenu-item").children("a").css({color:"#000"})),$("#work")[0].getBoundingClientRect().top<0&&$("#portfolio")[0].getBoundingClientRect().bottom>window.innerHeight&&($('.mynavbar [href="#portfolio"]').parent("li").css("background","#fff"),$('.mynavbar [href="#portfolio"]').parent(".respmenu-item").css({background:"#fff",color:"#000"}),$('.mynavbar [href="#portfolio"]').parent(".respmenu-item").children("a").css({color:"#000"})),$("#contacts")[0].getBoundingClientRect().top<window.innerHeight&&($('.mynavbar [href="#contacts"]').parent("li").css("background","#fff"),$('.mynavbar [href="#contacts"]').parent(".respmenu-item").css({background:"#fff",color:"#000"}),$('.mynavbar [href="#contacts"]').parent(".respmenu-item").children("a").css({color:"#000"})),$(".mynavbar")[0].getBoundingClientRect().top<=0&&($(".whoami").css("margin-top",$(".mynavbar").innerHeight()),$(".mynavbar").css({position:"fixed",top:"0"}),console.log("attach: "+$(".mynavbar").innerHeight())),$(".filter")[0].getBoundingClientRect().bottom>$(".mynavbar").innerHeight()&&(console.log("deteach: "+$(".mynavbar").innerHeight()),$(".mynavbar").removeAttr("style"),$(".whoami").removeAttr("style")),300<window.innerHeight-$(".skills-wraper")[0].getBoundingClientRect().top&&$(".skills-wraper").css({height:$(".more-wrap")[0].clientHeight+100+"px"}),200<window.innerHeight-$(".whoami")[0].getBoundingClientRect().top&&$('.whoami img[alt="myphoto"]').css("animation","leftBound 2s ease-in-out").delay(2e3).css("opacity","1"),$(".whatdo")[0].getBoundingClientRect().top<window.innerHeight&&0<$(".whatdo")[0].getBoundingClientRect().bottom&&$(".whatdo").css("background-position","right "+(-$(".whatdo")[0].getBoundingClientRect().top/1.2-200)+"px"),200<window.innerHeight-$(".whatdo")[0].getBoundingClientRect().top&&($(".whatdo h1").css("animation","leftBound .7s").delay(700).css("opacity","1"),setTimeout(function(){$(".whatdo .line").css("animation","leftBound .7s").delay(700).css("opacity","1")},500),$.each($(".icons"),function(e,n){setTimeout(function(){$(n).css("transform","translateX(-50%) scale(1)"),$(n).css({animation:"whatDo 1s"}),$(n).next("h3").css("animation","leftBound .7s").delay(700).css("opacity","1"),$(n).next("h3").next("p").css("animation","leftBound .7s").delay(700).css("opacity","1")},200+200*e)}),0),400<window.innerHeight-$(".portfolio")[0].getBoundingClientRect().top&&$.each($(".portfolio-item"),function(e,n){setTimeout(function(){$(n).css("animation","myworks .5s").delay(500).css("opacity","1")},200+200*e)})})}),$(function(){});